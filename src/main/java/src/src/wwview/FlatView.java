...
public class FlatView extends WWView {
	...
	public FlatView() {
		super(PropertySupport.TITLE, "Flat View", PropertySupport.ICONIFIABLE,
				...
				PropertySupport.CLOSABLE, true, PropertySupport.RESIZABLE,
				true, PropertySupport.WIDTH, 800, PropertySupport.HEIGHT, 300,
	...
	protected void customFeedback(List<String> fbs, MouseEvent e,
		...
		ViewFeedback.fbString(color, "map projection: "
				+ getFlatGlobe().getProjection().getName(), fbs);
	}
